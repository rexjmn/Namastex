...
- c:\wamp64\www\symfony_firstPro\test_symfony\.env.local
- c:\wamp64\www\symfony_firstPro\test_symfony\src\Service\EmailService.php
- c:\wamp64\www\symfony_firstPro\test_symfony\src\Controller\EmailConfirmationController.php
- c:\wamp64\www\symfony_firstPro\test_symfony\config\packages\messenger.yaml
- c:\wamp64\www\symfony_firstPro\test_symfony\templates\email_confirmation\index.html.twig
- c:\wamp64\www\symfony_firstPro\test_symfony\.env.dev
...
security:
    ...
    # La jerarquía de roles debe estar aquí, al mismo nivel que firewalls y access_control
    role_hierarchy:
...
<div style="max-width: 1200px; margin: 0 auto; padding: 0 20px;">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
        <h1 style="margin: 0; font-size: 32px; color: #333;">Mis Artículos</h1>
        <a href="{{ path('app_article_new') }}" style="background-color: #4CAF50; color: white; padding: 10px 15px; border-radius: 5px; text-decoration: none; display: inline-flex; align-items: center; gap: 5px;">
            <i class="fas fa-plus"></i>
                ...
                <div style="border: 1px solid #ddd; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1); transition: transform 0.3s ease; background-color: white;">
                    ...
                    <div style="display: flex; justify-content: space-between; padding: 15px 20px; border-top: 1px solid #eee;">
                        ...
                        <div style="display: flex; gap: 10px;">
                            ...
                            <a href="{{ path('app_article_delete', {'id': article.id}) }}" style="color: #e74c3c; text-decoration: none;" onclick="return confirm('¿Estás seguro de que deseas eliminar este artículo?')">
                                <i class="fas fa-trash"></i>
                                Eliminar
                            </a>
                        </div>
...
{% block title %}Hello EmailConfirmationController!{% endblock %}
...
<div class="example-wrapper">
    ...
    <ul>
        <li>Your controller at <code>C:/wamp64/www/symfony_firstPro/test_symfony/src/Controller/EmailConfirmationController.php</code></li>
        <li>Your template at <code>C:/wamp64/www/symfony_firstPro/test_symfony/templates/email_confirmation/index.html.twig</code></li>
    </ul>
</div>
{% endblock %}
...
###> symfony/framework-bundle ###
APP_SECRET=17a0a9dec0cc9cc9b30d92a260fd07bc
###< symfony/framework-bundle ###
